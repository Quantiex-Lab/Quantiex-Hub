...
// ERC20EventRecords map of transaction hashes to EthereumERC20Event structs
var ERC20EventRecords = make(map[string]EthereumERC20Event)

// ERC721EventRecords map of transaction hashes to EthereumERC721Event structs
var ERC721EventRecords = make(map[string]EthereumERC721Event)

// NewERC20EventWrite add a validator's address to the official claims list
func NewERC20EventWrite(txHash string, event EthereumERC20Event) {
	ERC20EventRecords[txHash] = event
}

// IsERC20EventRecorded checks the sessions stored events for this transaction hash
...
func NewERC721EventWrite(txHash string, event EthereumERC721Event) {
