 ...
 *      BinanceBank manages the minting and burning of tokens which
 *      represent Binance based assets, while EthereumBank manages
 *      the locking and unlocking of Ethereum and ERC20 token assets
 *      based on Ethereum.
 **/

contract BridgeBank is BinanceBank, EthereumBank {
