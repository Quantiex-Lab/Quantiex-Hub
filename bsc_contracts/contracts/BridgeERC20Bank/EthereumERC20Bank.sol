...
contract EthereumERC20Bank {
    ...
    /*
     * @dev: Deploys a new BridgeERC20Token contract
     *
     * @param _symbol: The BridgeERC20Token's symbol
     */
    ...
    function mintNewBridgeTokens(
        ...
        // Mint bridge tokens
        require(
            BridgeERC20Token(_bridgeTokenAddress).mint(_intendedRecipient, _amount),
